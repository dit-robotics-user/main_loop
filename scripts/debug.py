...
def from_goap_callback(data):
	...
	mission_child_name  = "mission_child_name:" + str(data.mission_child_name)
...
txST1_sub = rospy.Subscriber('/Goap_response', goap_debug, from_goap_callback)
rxST1_sub = rospy.Subscriber('/Main_state', main_debug, main_state_callback)
