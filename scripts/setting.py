...
def setting(mode, action_list, current_world_state, mission_list, my_pos, my_degree, cup_color, direction):
	if mode is 1:
		...
		c3 = Action('cup_get2', ['cup_prepare'], ['cup_get'], [a3, a7, a6], (105, 2170), 180, 150, 3, 1, 15, 4, 4, True)
		...
		c11 = Action('put_green2', ['cup_set'], ['green2_put'], [a4, a11, a6], (600, 180), 0, 150, 3, 1, 15, 4, 4, True)
		c12 = Action('put_leftover2', ['green2_put'], ['leftover2_put'], [a4, a7, a6], (700, 600), 270, 150, 3, 1, 15, 4, 4, True)
	...
	return action_list, current_world_state, mission_list, my_pos
