			...
			if len(path) != 0:
				...
				while len(top_path.child_action) != 0:
					...
					if MyClass.action_done is True and MyClass.output_mission_child_name == MyClass.input_child_name:
						...
						if MyClass.output_mission_child_name == 'lift_left':
							current_left_layer -= 1
						elif MyClass.output_mission_child_name == 'lift_right':
							current_right_layer -= 1
						elif MyClass.output_mission_child_name == 'lower_left':
							current_left_layer += 1
						elif MyClass.output_mission_child_name == 'lower_right':
							current_right_layer += 1
