...
def setting(mode):
    if mode is 1:
		...
		c3 = Action("cup3",      ['4'],        ['get_cup'], (400, 1200), 3, 60, 150, 1, 0, 1, True, True)
		...
		c8 = Action('goto',      [],           [], (1000, 1250), 3, 0, 150, 1, 15, 5, False, True)
		c16 = Action('goto1',      [],           [], (700, 500), 3, 90, 150, 1, 15, 5, False, True)
